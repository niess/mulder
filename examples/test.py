...
position = layers[0].coordinates(position)
position.height -= 30
...
direction = mulder.Direction(azimuth=0, elevation=25)
...
reference = meter.reference.flux(direction.elevation, energy)
